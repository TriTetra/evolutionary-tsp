...
# DÜZELTME BURADA: stop_threshold
stop_threshold = st.sidebar.number_input(
    "Kararlılık Sınırı (Early Stop)",
    min_value=0,
    max_value=1000,
    value=200,
    step=50,
    help="Belirtilen nesil sayısı kadar iyileşme olmazsa evrimi durdurur. 0 ise kapalıdır."
)
